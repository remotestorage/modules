...
RemoteStorage.defineModule("pictures", function (privateClient, publicClient) {
  ...
  var exports = {
     ...
     */
    listPublicAlbums: function listPublicAlbums() {
     ...
     *   An array with the albums names.
     */
    listPrivateAlbums: function listPrivateAlbums() {
     ...
     */
    openPublicAlbum: function openPublicAlbum(name) {
     ...
     *   The (synchronized) album.
     */
    openPrivateAlbum: function openPrivateAlbum(name) {
   ...
   */
  var Album = function Album(name, client) {
    /**
     * Property: name
     *
     * The <Album> name.
  ...
  Album.prototype = {
     ...
     */
    store: function store(mimeType, name, data) {
      return this.client.storeFile(mimeType, name, data).then((function () {
     ...
     */
    getPictureURL: function getPictureURL(name) {
...
},{}]},{},["/home/basti/src/remotestorage/modules/src/pictures.js"]);
